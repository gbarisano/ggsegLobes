...
knitr::opts_chunk$set(
  ...
  out.width = "100%", dpi = 150, message = FALSE, warning = FALSE
)
```
...
```{r atlas, fig.width = 10, fig.height = 5}
library(ggseg)
library(ggsegLobes)
library(ggplot2)
...
The atlas also renders in 3D with [`ggseg3d`](https://github.com/ggsegverse/ggseg3d):
...
- **Frontal:** superior/middle/inferior frontal, precentral, orbitofrontal,
  frontal pole, paracentral, anterior + posterior cingulate
